    ...
    <div className="banner_image  h-[400px] md:h-[500px] lg:h-[600px] w-full rounded-3xl flex items-center">
      <div className="text-center px-2 md:px-16 lg:px-32">
        ...
        <p className="text-sm md:text-lg text-white mb-4 md:mb-10">
          Unfortunately, figuring out recipe calories often requires manual
          effort. But there are online calculators that can estimate them! These
          tools analyze ingredient lists to give you a calorie count per
          serving.
        </p>
